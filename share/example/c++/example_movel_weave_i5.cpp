...
{
    // API call: Start the runtime.
    // Note: The runtime must be started for weave motion, otherwise it will not take effect.
    ...
    robot_interface->getMotionControl()->moveLine(pose2, 0.05, 0.01, 0.025, 0);
    ...
    // Stop the runtime after the weave motion ends
    cli->getRuntimeMachine()->stop();
}

/**
 * Function: Robot arm weave motion
 * Steps:
 ...
 *       start weaving, weave motion to position 2,
 *       end weaving, stop runtime
